...
if __name__ == "__main__":
    ...
    carla = CARLA(args.config_env, args.config_exp_pre, args.fname, args.device, args.verbose, args.tensorboard)
    ...
    carla = CARLA(args.config_env, args.config_exp_class, args.fname, args.device, args.verbose, args.tensorboard, version=version)
